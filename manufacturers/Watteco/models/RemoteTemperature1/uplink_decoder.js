...
let batch_param = [1, [{taglbl: 0,resol: 10, sampletype: 7,lblname: "temperature", divide: 100, unit: "CEL", datasetId: "Temperature1:Raw"},
    { taglbl: 1, resol: 100, sampletype: 6,lblname: "batteryLevel", divide: 1000, unit: "VLT", datasetId: "disposable_battery_voltage:Raw"}]];
...
let endpointCorresponder={
    ...
    temperature: ["temperature", "Temperature1:Raw", "CEL"]
}
